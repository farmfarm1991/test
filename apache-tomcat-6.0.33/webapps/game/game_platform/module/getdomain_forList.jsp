...
<span class="specborder" style="display: none;">
	<select id="years" class="sixfilter" onclick='returnyear(103)'>
		<option value="y%" class='text' id='allyears'>年度</option>
		<option value="y%" class='text' id='allyears'>所有</option>
...
<span class="specborder" style="display: none;">
	<select id="sOrder" class="sixfilter">
		<option value="s%" class='text' id='allorder'>學期</option>
		<option value="s%" class='text' id='allorder'>所有</option>
...
<span class="specborder">
	<select id="area" class="sixfilter">
		<option value="a%" class='text' id='allarea'>地區</option>
		<option value="a%" class='text' id='allarea'>所有</option>
...
<span class="specborder">
	<select id="city" class="sixfilter">
		<option value="c%" class='text' id='allcity'>縣市</option>
		<option value="c%" class='text' id='allcity'>所有</option>
<%
String lastSelected = "";
...
<span class="specborder">
	<select id="gradeID" class="sixfilter">
		<option value="g%" class='text' id='allgrade'>年級</option>
		<option value="g%" class='text' id='allgrade'>所有</option>
<%
...
<span class="specborder">
	<select id="domain" class="sixfilter">
		<option value="t%" class='text' id='alldomain'>領域</option>
		<option value="t%" class='text' id='alldomain'>所有</option>
<%
String preSelected = "";
	...
	for(var i = 0; i < allDomainArray.length-1 ; i++){
		...
		else if(["1", "2", "3", "4","5", "6"].indexOf(text)>-1)
		{
			if( allDomainArray[i].id == 'Elementary_label' ){
				...
				$('#domain').append(allDomainArray[allDomainArray.length-1]);
				thisSelected=1;
			}
		}
